...
服务器是计算资源丰富的远端计算机,我们需要和服务器建立远程连接来使用服务器设备,每一台服务器像普通的计算机一样拥有自己的软件程序,硬件设备和操作系统    
...
git是代码版本管理库,能够实现他人协作  
git一般存在于本地

1. 从github上下载软件  
方法: 进入到github想要下载的程序文件的界面,找到左上角绿色图标的code,点击之后复制出现的网址  
在命令行输入以下指令  
> git clone git@github.com:10cbvkw/Linux-Servers.git  
